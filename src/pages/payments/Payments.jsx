...
const Payments = () => {
  ...
  const [payments, setPayments] = useState([
    { _id: "1", type: "payment", customerName: "John Doe", invoiceNo: "INV-001", date: "2026-05-01", amount: 5000, paymentMode: "cash" },
    { _id: "2", type: "payment", customerName: "Jane Smith", invoiceNo: "INV-002", date: "2026-05-02", amount: 10000, paymentMode: "upi" },
    { _id: "3", type: "return", customerName: "Bob Johnson", invoiceNo: "INV-003", date: "2026-05-03", amount: 2000, paymentMode: "cash" },
  ]);
  ...
  const [invoices, setInvoices] = useState([
    { _id: "1", invoiceNo: "INV-001", customerId: "1" },
    { _id: "2", invoiceNo: "INV-002", customerId: "2" },
    { _id: "3", invoiceNo: "INV-003", customerId: "3" },
  ]);
...
const handleCustomerChange = (e) => {
  ...
  const invoice = invoices.find(i => i._id === form.invoiceId);
  ...
  const handleSaveEdit = (e) => {
    ...
    setPayments(payments.map(p => p._id === editData._id ? editData : p));
          ...
          <tbody>
            {payments.map((p) => (
              <tr key={p._id}>
                ...
                <td style={{...styles.td, fontWeight: 'bold'}}>{p.customerName}</td>
                <td style={styles.td}>{p.invoiceNo}</td>
          ...
          <div style={styles.modal}>
            ...
            <form onSubmit={handleSaveEdit} style={styles.form}>
               ...
               <div style={styles.modalInputGroup}>
                  ...
                  <input style={styles.modalInput} value={editData.invoiceNo} readOnly />
               </div>
               <div style={styles.modalInputGroup}>
