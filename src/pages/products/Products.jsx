...
const Products = () => {
  const [products, setProducts] = useState([
    { _id: "1", name: "Vanilla Ice Cream", rate: 450, discount: 5, stockQty: 100, lowStockAlert: 10 },
    { _id: "2", name: "Chocolate Bars", rate: 120, discount: 10, stockQty: 50, lowStockAlert: 5 },
    { _id: "3", name: "Strawberry Syrup", rate: 300, discount: 0, stockQty: 20, lowStockAlert: 5 },
  ]);
...
const handleSaveProduct = (data) => {
  if (editProduct) {
    setProducts(products.map(p => p._id === editProduct._id ? { ...p, ...data, stockQty: (Number(p.stockQty) || 0) + (Number(data.addStock) || 0) } : p));
  } else {
