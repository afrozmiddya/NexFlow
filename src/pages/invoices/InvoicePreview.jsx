      ...
      <div style={styles.container}>
        ...
        <div className="printable-area" style={styles.invoiceCard}>
          <div style={styles.header}>
            <h1 style={styles.brandName}>NexFlow</h1>
            <p style={styles.brandSub}>Workflow Solutions Authorized Distributor</p>
            <p style={styles.brandSub}>Silicon Valley, CA - 94025</p>
            <p style={styles.brandSub}>Contact Number: +1 800-NEX-FLOW</p>
