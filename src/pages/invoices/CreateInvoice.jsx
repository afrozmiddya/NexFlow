...
const CreateInvoice = () => {
  ...
  const [customers, setCustomers] = useState([
    { _id: "1", name: "John Doe", contact: "9876543210", address: "Kolkata, WB", dueAmount: 5000 },
    { _id: "2", name: "Jane Smith", contact: "8765432109", address: "Mumbai, MH", dueAmount: 0 },
  ]);
  const [products, setProducts] = useState([
    { _id: "1", name: "Vanilla Ice Cream", rate: 450, discount: 5, stockQty: 100 },
    { _id: "2", name: "Chocolate Bars", rate: 120, discount: 10, stockQty: 50 },
  ]);
 ...
 if (field === "qty") {
  ...
  if (!selectedCustomer._id || items.length === 0) {
    ...
    // ✅ Navigate to preview with DEMO invoice
