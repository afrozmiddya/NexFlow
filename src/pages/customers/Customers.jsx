...
const Customers = () => {
  const [customers, setCustomers] = useState([
    { _id: "1", name: "John Doe", contact: "9876543210", address: "Kolkata, WB", totalPurchase: 50000, totalPaid: 45000 },
    { _id: "2", name: "Jane Smith", contact: "8765432109", address: "Mumbai, MH", totalPurchase: 30000, totalPaid: 30000 },
    { _id: "3", name: "Bob Johnson", contact: "7654321098", address: "Delhi, DL", totalPurchase: 20000, totalPaid: 15000 },
  ]);
  ...
  const handleSave = (e) => {
    ...
    if (editCustomer) {
      setCustomers(customers.map(c => c._id === editCustomer._id ? { ...c, ...formData, totalPaid: formData.paid } : c));
    } else {
      setCustomers([...customers, { ...formData, _id: Date.now().toString(), totalPaid: formData.paid }]);
    }
