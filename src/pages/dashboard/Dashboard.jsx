...
const Dashboard = () => {
  ...
  const [lowStockData, setLowStockData] = useState([
    { id: 1, name: "Vanilla Ice Cream", rate: 450, discount: 5, stockQty: 5 },
    { id: 2, name: "Chocolate Bars", rate: 120, discount: 10, stockQty: 10 },
    { id: 3, name: "Strawberry Syrup", rate: 300, discount: 0, stockQty: 2 },
  ]);
...
const [topCustomers, setTopCustomers] = useState([
  { _id: "1", name: "John Doe", totalPurchase: 15000 },
  { _id: "2", name: "Jane Smith", totalPurchase: 12000 },
  { _id: "3", name: "Bob Johnson", totalPurchase: 10000 },
]);
